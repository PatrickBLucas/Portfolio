...
const FEATURED = [
  {
    ...
    outcome: 'Built and fully functional, with the architecture ready to replace the paper-based operation outright. Not yet moved into daily production use, that decision sits with leadership. The same architecture applies to any small distributor or multi-location operation running without formal inventory infrastructure.',
