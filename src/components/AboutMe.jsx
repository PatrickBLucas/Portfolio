    ...
    <div>
      ...
      <div className="card fade-up fade-up-2" style={{ marginBottom: '1rem' }}>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '1rem' }}>
          I am a Senior Operations and Systems Manager based in Shelton, CT. I directly manage one location but operate across a much larger footprint: a mason supply network spanning seven branches, a fabrication and distribution center, quarry operations across four sites, an asphalt plant, a building division, and shared fleet and repair resources. I also oversee physical inventory counts and reconciliation for four additional branches. I have spent a decade inside that organization, and in that time I have done something fairly unusual: I have built a suite of operational tools that the company now runs on daily, none of which anyone asked for.
        </p>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '1rem' }}>
          None of them were requested. All of them are in daily use. And every one of them was built to eliminate a cost, close a gap, or remove a dependency that nobody else had gotten around to fixing. A procurement process that took days and generated invisible cost misallocations now runs in minutes with consistent, auditable results. A subsidiary operating on carbon copy paper now has a full ERP. A routing decision that was costing the company money on every wrong delivery now takes three seconds to get right. The tools are different. The pattern is always the same.
        </p>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '1rem' }}>
          My instinct when I encounter a broken process is not to work around it. It is to understand exactly why it is broken, design something that eliminates it, and make sure it does not need me to babysit it afterward.
        </p>
