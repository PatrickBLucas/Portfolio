    ...
    <div>
      ...
      <div className="card fade-up fade-up-2" style={{ marginBottom: '1rem' }}>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '1rem' }}>
          I am a Senior Operations and Systems Manager based in Shelton, CT. I directly manage one location but operate across a much larger footprint -- a mason supply network spanning seven branches, coordination with four O&G-owned quarry sites, an asphalt plant, and shared fleet resources where I log equipment hours and support maintenance scheduling. I also supply materials into O&G's building division and oversee physical inventory counts and reconciliation for four additional branches. I work closely with the company's stone fabrication and distribution center in Beacon Falls, sourcing imported granite and custom-cut work, hand-crafted and CNC water jet, for masonry projects across the network. I have spent a decade inside that organization, and in that time I have done something fairly unusual: I have built a suite of operational tools that the company now runs on daily, none of which anyone asked for.
        </p>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '1rem' }}>
